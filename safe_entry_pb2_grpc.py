...
class SafeEntryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckExposureHistory = channel.unary_unary(
                '/safe_entry.SafeEntry/CheckExposureHistory',
...
class SafeEntryServicer(object):
    ...
    def CheckExposureHistory(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SafeEntryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CheckExposureHistory': grpc.unary_unary_rpc_method_handler(
...
class SafeEntry(object):
    ...
    @staticmethod
    def CheckExposureHistory(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/safe_entry.SafeEntry/CheckExposureHistory',
            safe__entry__pb2.CheckExposureHistoryRequest.SerializeToString,
            safe__entry__pb2.CheckExposureHistoryReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class SpecialAccessStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ShowClusters = channel.unary_unary(
                '/safe_entry.SpecialAccess/ShowClusters',
                request_serializer=safe__entry__pb2.ShowClusterRequest.SerializeToString,
                response_deserializer=safe__entry__pb2.ShowClusterReply.FromString,
                )
...
class SpecialAccessServicer(object):
    ...
    def ShowClusters(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SpecialAccessServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ShowClusters': grpc.unary_unary_rpc_method_handler(
                    servicer.ShowClusters,
                    request_deserializer=safe__entry__pb2.ShowClusterRequest.FromString,
                    response_serializer=safe__entry__pb2.ShowClusterReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class SpecialAccess(object):
    ...
    def ShowClusters(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/safe_entry.SpecialAccess/ShowClusters',
            safe__entry__pb2.ShowClusterRequest.SerializeToString,
            safe__entry__pb2.ShowClusterReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
